...
using CommonUIBase.Controls.Runtimes.User32;
using CommonUIBase.Controls.Runtimes.Shell32;
using CommonUIBase.Controls.Runtimes;
using CommonUIBase.Controls.Runtimes.Interop;

namespace CommonUIBase.Controls
{
    public class NotifyIcon : FrameworkElement, IDisposable
    {
        ...
        public NotifyIcon()
        {
            _TrayWndClassName = $"TimerHint_{Guid.NewGuid()}";
